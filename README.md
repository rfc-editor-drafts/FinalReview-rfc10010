# Final Review for RFC-to-be 10009 (draft-ietf-netconf-netconf-client-server-41) (in XML)

This repository is for managing document updates for RFC 10009 during Final Review (previously AUTH48). This is part of the [pilot GitHub-based process for Final Review](https://www.rfc-editor.org/rpc/wiki/doku.php?id=rpc_github_roadmap), and it emulates the [current Final Review procedure](https://authors.ietf.org/en/rfc-publication-process). 

Please see the [License](https://github.com/rfc-editor-drafts/FinalReview-rfc10009/blob/RPC-edits/LICENSE). The [IETF Note Well](https://github.com/rfc-editor-drafts/FinalReview-rfc10009/blob/Approved/note-well.md) applies.
...
* [https://www.rfc-editor.org/authors/rfc10009.html](https://www.rfc-editor.org/authors/rfc10009.html)
* [https://www.rfc-editor.org/authors/rfc10009.pdf](https://www.rfc-editor.org/authors/rfc10009.pdf)
* [https://www.rfc-editor.org/authors/rfc10009.txt](https://www.rfc-editor.org/authors/rfc10009.txt)
* [https://www.rfc-editor.org/authors/rfc10009.xml](https://www.rfc-editor.org/authors/rfc10009.xml)

The following diff files are also available via www.rfc-editor.org:
* [https://www.rfc-editor.org/authors/rfc10009-diff.html](https://www.rfc-editor.org/authors/rfc10009-diff.html) (all changes since the document entered the RFC Editor Queue)
* [https://www.rfc-editor.org/authors/rfc10009-rfcdiff.html](https://www.rfc-editor.org/authors/rfc10009-rfcdiff.html) (side-by-side view of all changes since the document entered the RFC Editor Queue)
...
Details about the status of your Final Review are here: [https://queue.rfc-editor.org/final-review/rfc10009/](https://queue.rfc-editor.org/final-review/rfc10009/)
